...
/** @hide */
	...
	public lil_listener (java.util.concurrent.Executor p0)
	{
		super (p0);
		if (getClass () == lil_listener.class)
			mono.android.TypeManager.Activate ("меньше_3_Droid.lil_listener, меньше 3.Android", "Java.Util.Concurrent.IExecutor, Mono.Android", this, new java.lang.Object[] { p0 });
	}
